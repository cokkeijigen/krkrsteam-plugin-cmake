...
ttstr convertUtf8StringToTtstr(const std::string &buf)
{
...
{
public:
	SteamScreenshotCallback() : SteamCallback(), m_CallbackScreenshotRequested(this, &SteamScreenshotCallback::OnScreenShotRequested)
...
void SteamScreenshotCallback::OnScreenShotRequested(ScreenshotRequested_t *pCallback)
{
...
{
public:
	SteamBroadcastCallback() : SteamCallback(), m_CallbackBroadcastStart(this, &SteamBroadcastCallback::OnBroadcastStart), m_CallbackBroadcastStop(this, &SteamBroadcastCallback::OnBroadcastStop)
	{
	}
...
void SteamBroadcastCallback::OnBroadcastStart(BroadcastUploadStart_t *pCallback)
{
	tTJSVariant state(1), *args = &state;
	invokeCallback(1, &args);
}
void SteamBroadcastCallback::OnBroadcastStop(BroadcastUploadStop_t *pCallback)
{
